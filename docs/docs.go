...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/ratelimit/check": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Target and bucket key",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request or bucket key does not match scope",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    },
                    ...
                    "403": {
                        "description": "Target key outside token scope",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    },
                    "404": {
                        "description": "Unknown external target",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    },
                    "503": {
                        "description": "External rate limiting disabled",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.createExternalTargetRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Target key already exists",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    }
        ...
        "/ratelimit/targets/{key}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Not an external target",
                        "schema": {
                            "$ref": "#/definitions/github_com_all-in-one_internal_http.Response"
                        }
                    },
        ...
        "/ratelimit/tokens": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.AppToken"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "App, name, optional scope prefix",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.createTokenRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.createTokenResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "handler.createExternalTargetRequest": {
            "type": "object",
            "properties": {
                "app": {
                    "type": "string"
        ...
        "model.Summary": {
            ...
            "properties": {
                "chat": {
                    "$ref": "#/definitions/model.ChatStats"
                },
                "listing": {
                    "$ref": "#/definitions/model.ListingStats"
                },
                "shortener": {
                    "$ref": "#/definitions/model.ShortenerStats"
                }
            }
        },
        "model.Target": {
